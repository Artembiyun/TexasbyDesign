              ...
              <ol>
                <li className={styles.field + " " + styles.field__padded}>
                  ...
                  {this.state.nameErr ? (
                    <div
                      ...
                      id="firstName_feedbackBox"
                    >
                      <span
                        className={styles.feedbackBox__span}
                        id="firstName_feedback"
                      >
                        This field contains invalid characters. Please make sure
                        to use only alphabetic characters, spaces, hyphens and
                        periods
                      </span>
                    </div>
                  ) : null}
                ...
                <li className={styles.field + " " + styles.field__padded}>
                  ...
                  {this.state.pCodeErr ? (
                    <div
                      className={styles.feedbackBox}
                      id="postalCode_feedbackBox"
                    >
                      <span
                        className={styles.feedbackBox__span}
                        id="postalCode_feedback"
                      >
                        This field is in the wrong format. Use the format H0H0H0
                        instead
                      </span>
                    </div>
                  ) : null}
                ...
                <li className={styles.field + " " + styles.field__padded}>
                  ...
                  {this.state.pNumberErr ? (
                    <div
                      className={styles.feedbackBox}
                      id="phoneNumber_feedbackBox"
                    >
                      <span
                        className={styles.feedbackBox__span}
                        id="phoneNumber_feedback"
                      >
                        This field is in the wrong format. Use the format
                        111-111-1111 instead
                      </span>
                    </div>
                  ) : null}
                </li>
              ...
              <ol>
                <li className={styles.checkboxList}>
                  ...
                  <div className={styles.checkboxList__text}>
                    ...
                    information, newsletters and special offers. Would you like
                    to receive these? You may withdraw your consent at any time.
                    View our{" "}
                    <a
                ...
                <li className={styles.checkboxList}>
                  ...
                  <div className={styles.checkboxList__text}>
                    <p className={styles.optionalb}>(Optional)</p> From time to
                    time, <strong>Cityline</strong> would like to send you
                    offers and e-newsletters, including information about our
                    latest articles, special events, promotions, and more! You
                    may withdraw your consent at any time. View our{" "}
                    <a
                      className={styles.privacyPolicy}
                ...
                <li className={styles.checkboxList}>
                  ...
                  <div className={styles.checkboxList__text}>
                    ...
                    <Modal open={open} onClose={this.onCloseModal} center>
                      ...
                      <p>
                        Lorem ipsum dolor sit amet, duo porro dicit conceptam
                        ei, vero propriae duo ad, est docendi adversarium ea. Ne
                        vim iuvaret vocibus consectetuer. Sed in case altera,
                        feugiat appetere repudiare duo te. Eam numquam indoctum
                        eu, cu vim erant iudico consectetuer. Nisl posse
                        torquatos ea his, tempor graecis deleniti pro eu, ea
                        illum pericula disputationi mea. Ex debet luptatum pri,
                        illum tantas nostrud vim in.
                      </p>
                    </Modal>
                  </div>
                </li>
